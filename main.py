...
def image_noise(path_to_image, sigma, noise_type='gaussian'):
    ...
    if noise_type == 'poisson':
        ...
        image_array_noise = image_array + poisson_noise
...
noise_type = "poisson"
# noise_type = "gaussian"
quantizer_parameter_array = [27]
# quantizer_parameter_array = np.arange(1, 51, 1)
# quantizer_parameter_array = np.arange(1, 51, 1)
sigma_array = [0.02]
# sigma_array = np.arange(0.0, 0.08, 0.008)
...
# plt.ylabel('psnr')
# plt.show()
#print(f'path_to_noised_images={path_to_noised_images}')
run_plot()
#run_plot_fig()